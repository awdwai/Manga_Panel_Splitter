...
Data is written to `zuhobooks/data/db.json` on every create, update, and delete. Restarting the server keeps your books intact. The first launch seeds a small demo organization so the dashboard is not empty.
