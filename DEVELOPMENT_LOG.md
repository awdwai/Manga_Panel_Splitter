...
- Replaced the exposed click/brush masking workflow with a faster body-part review table, search/filter/sort controls, selected-part boundary editor, edge snapping, selected-layer resegmentation, and a fixed bottom review toolbar.
